...
export default function WhyYouSelector() {
  ...
  return (
    <div>
        ...
        {BACKGROUNDS.map((b) => (
          <button
            ...
            className={`flex items-center gap-2 rounded-full border px-4 py-2.5 text-sm font-semibold transition ${
              active === b.key
                ? "border-royal bg-royal text-white shadow-[0_8px_20px_-6px_rgba(47,79,214,0.5)]"
      ...
      <div className="mt-8 rounded-3xl border border-navy/10 bg-white p-8 text-center card-shadow sm:p-10">
