...
/** Mesh-gradient + grain backdrop for the orientation hero. Accepts an optional scroll-linked style (e.g. blur-on-recede). */
export default function HeroBackdrop({ style }: { style?: MotionStyle }) {
  return (
    <motion.div style={style} aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
